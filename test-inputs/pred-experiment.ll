; ModuleID = 'test-inputs/pred-experiment.cpp'
source_filename = "test-inputs/pred-experiment.cpp"
...
entry:
  ...
  %call1 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNSirsERi(ptr noundef nonnull align 8 dereferenceable(16) %call, ptr noundef nonnull align 4 dereferenceable(4) %b)
